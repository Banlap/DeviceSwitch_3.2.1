...
public class PermissionPageUtils {
    ...
    //自己的项目包名
    private String packageName = AApplication.getInstance().getPackageName();
    ...
    public void jumpPermissionPage() {
        ...
        ALog.d(TAG, "jumpPermissionPage --- name : " + name);
        switch (name) {
            case "HUAWEI":
                goHuaWeiMainager();
                break;
    ...
    private void goXiaoMiMainager() {
        ...
        ALog.d(TAG, "goMiaoMiMainager --- rom : " + rom);
    ...
    private void doStartApplicationWithPackageName(String packagename) {
        ...
        ALog.d("PermissionPageManager", "resolveinfoList" + resolveinfoList.size());
        for (int i = 0; i < resolveinfoList.size(); i++) {
            ALog.e("PermissionPageManager", resolveinfoList.get(i).activityInfo.packageName + resolveinfoList.get(i).activityInfo.name);
        }
